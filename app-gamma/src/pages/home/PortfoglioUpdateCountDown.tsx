...
const nextPortfolioUpdate = updatesDates.find((update:UpdatesDates) => 
    new Date(update.date).getTime()-Date.now() >0)
const nextPortfolioUpdateDate = dayjs(nextPortfolioUpdate?.date).format('DD MMM YY')
